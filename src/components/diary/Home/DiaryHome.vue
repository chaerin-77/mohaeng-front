...
<template>
  <div class="flex flex-col justify-between h-[50rem]">
    <div class="">
    ...
    <div class="flex justify-between mt-12">
      <div class="w-1/2 py-4 mr-4">
        <p class="text-xl font-semibold mb-3">To Do List</p>
        <DiaryHomeToDo />
      </div>
      <div class="w-1/2 py-4 ml-4">
        <p class="text-xl font-semibold mb-3">Talk</p>
        <div class="bg-main-color rounded-xl w-full h-96 p-4 overflow-y-scroll">
          <DiaryHomeTalk />
        </div>
        <!-- talk 입력 -->
